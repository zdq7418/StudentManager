...
public class DefaultRegisterView extends FrameLayout implements RegisterView {
    ...
    public interface DefaultRegisterViewListener {
        void onRegister(TextInputLayout registerUser, TextInputLayout registerPass, TextInputLayout registerPassRep, Switch role);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final Switch role= (Switch) findViewById(R.id.role);
